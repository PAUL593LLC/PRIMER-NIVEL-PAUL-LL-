class Libro:
    ...
    def __str__(self):
        return f"Título: {self.titulo_autor[0]}, Autor: {self.titulo_autor[1][0]} {self.titulo_autor[1][1]}, Categoría: {self.categoria}, ISBN: {self.isbn}"
    ...
    def buscar_libro(self, termino_busqueda):
        ...
        for libro in self.libros.values():
            if termino_busqueda.lower() in libro.titulo_autor[0].lower() or \
               termino_busqueda.lower() in libro.titulo_autor[1][0].lower() or \
               termino_busqueda.lower() in libro.titulo_autor[1][1].lower() or \
...
libro1 = Libro("El Quijote", ("Cervantes", "Miguel de"), "Literatura", "12345")
